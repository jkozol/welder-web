            ...
            <Form isHorizontal>
              {Object.keys(providerSettings[provider].auth).map(key => (
                <FormGroup
                  label={formatMessage({
                    id: `${provider}-auth`,
                    defaultMessage: providerSettings[provider].auth[key].display_text
                  })}
                  fieldId={key}
                  key={key}
                >
                  <TextInput
                    ...
                    type={providerSettings[provider].auth[key].is_password ? "password" : "text"}
                    id={key}
                    key={key}
              ...
              {Object.keys(providerSettings[provider].settings).map(key => (
                <FormGroup
                  label={formatMessage({
                    ...
                    defaultMessage: providerSettings[provider].settings[key].display_text
                  })}
                  fieldId={key}
                  key={key}
                >
                  <TextInput
                    value={this.state.uploadSettings[key] || ""}
                    type={providerSettings[provider].settings[key].is_password ? "password" : "text"}
                    id={key}
                    key={key}
                    onChange={this.setUploadSettings}
                    isRequired
                ...
                {Object.keys(providerSettings[uploadService].auth).map(key => (
                  <React.Fragment key={key}>
                    <TextListItem component={TextListItemVariants.dt}>
                      {formatMessage({
                        id: "review-settings",
                        defaultMessage: providerSettings[uploadService].auth[key].display_text
                      })}
                    </TextListItem>
                    <TextListItem component={TextListItemVariants.dd}>
                      {providerSettings[uploadService].auth[key].is_password &&
                ...
                {Object.keys(providerSettings[uploadService].settings).map(key => (
                  <React.Fragment key={key}>
                    <TextListItem component={TextListItemVariants.dt}>
                      {formatMessage({
                        id: "review-settings",
                        defaultMessage: providerSettings[uploadService].settings[key].display_text
                      })}
                    </TextListItem>
                    <TextListItem component={TextListItemVariants.dd}>
                      {providerSettings[uploadService].settings[key].is_password &&
                      this.state.uploadSettings[key] != undefined
                        ? "*".repeat(this.state.uploadSettings[key].length)
                        : this.state.uploadSettings[key]}
                    </TextListItem>
